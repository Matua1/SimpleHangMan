...
class HangManApp:
    def __init__(self, master):
        ...
        # Introduction screen
        self.intro_label = ttk.Label(self.master, text="Welcome to Hangman!\nGuess the word letter by letter.")
        self.intro_label.pack()
        self.start_button = ttk.Button(self.master, text="Start Game", command=self.start_game)
        self.start_button.pack()

         # Create a style object for ttk.Button
    ...
    def create_buttons(self):
        for idx, letter in enumerate('abcdefghijklmnopqrstuvwxyz'):
            button = ttk.Button(self.buttons_frame, text=letter.upper(), command=lambda l=letter: self.make_guess(l), style='TButton')
